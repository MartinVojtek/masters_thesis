...
data        <- read_excel("HLW_rstar_in_world.xlsx") 
data        <- as.data.frame(data)
#data glance
head(data)

#convert to time series
dataUS       <- ts(data$`US`, start = c(1972,4), end = c(2020,1), frequency = 4)
dataCanada   <- ts(data$`Canada`, start = c(1972,4), end = c(2020,1), frequency = 4)
dataEuroArea <- ts(data$`EuroArea`, start = c(1972,4), end = c(2020,1), frequency = 4)
dataUK       <- ts(data$`UK`, start = c(1972,4), end = c(2020,1), frequency = 4)
